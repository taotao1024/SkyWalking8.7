 ...
 *
 *
 * AgentPackagePath 是一个用于定位 SkyWalking agent.jar 的标志和查找器。它获取代理 jar 的绝对路径。
 * 该路径是代理核心查找插件和工具包激活所需的元数据。如果查找机制失败，代理将直接退出。
 */
public class AgentPackagePath {
    ...
    private static File findPath() throws AgentPackageNotFoundException {
        ...
        // AgentPackagePath 一般情况下被 AppClassLoader 加载
