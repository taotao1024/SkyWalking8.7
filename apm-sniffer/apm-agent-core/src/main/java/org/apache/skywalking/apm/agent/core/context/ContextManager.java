...
public class ContextManager implements BootService {
    ...
    /**
     * RuntimeContext： TraceContext 有时候需要记录一些额外的信息，那么就记录在 RuntimeContext 中
     */
     ...
     * <p>
     * 推荐使用ContextManager::stopSpan(AbstractSpan span)，因为这样，TracingContext核心可以验证该span是否是活动的，
     * 以避免意外停止span。如果当前跨度很难获得或者只能通过低性能的方式获得，这种停止方式仍然可以接受。
     */
