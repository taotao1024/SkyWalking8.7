...
public class Config {
    ...
    public static class Agent {
         ...
         * 3 seconds tops.
         * <p>
         * 默认情况下，负数或零表示关闭。 {@code SAMPLE_N_PER_3_SECS} 表示在 3 秒内采样 N 个 {@link TraceSegment}。
         */
         ...
         * <p>
         * 如果为 true，SkyWalking 代理会将所有插桩的类文件保存在 'debugging' 文件夹中。SkyWalking 团队可能会要求提供这些文件以解决兼容问题。
         */
