...
public interface QueryInfoRequestOrBuilder extends
   ...
   */
  java.util.List<com.taotao.proto.grpc.demo.personalInfo> 
      getPersonalInfoRecordsList();
  /**
   * <code>repeated .grpcprotocol.personalInfo personalInfoRecords = 4;</code>
   */
  com.taotao.proto.grpc.demo.personalInfo getPersonalInfoRecords(int index);
  /**
   * <code>repeated .grpcprotocol.personalInfo personalInfoRecords = 4;</code>
   */
   ...
   * <code>repeated .grpcprotocol.personalInfo personalInfoRecords = 4;</code>
   */
  java.util.List<? extends com.taotao.proto.grpc.demo.personalInfoOrBuilder> 
      getPersonalInfoRecordsOrBuilderList();
  /**
   * <code>repeated .grpcprotocol.personalInfo personalInfoRecords = 4;</code>
   */
  com.taotao.proto.grpc.demo.personalInfoOrBuilder getPersonalInfoRecordsOrBuilder(
      int index);
