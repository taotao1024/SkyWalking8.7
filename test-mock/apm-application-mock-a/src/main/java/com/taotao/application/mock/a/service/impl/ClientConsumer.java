...
import com.taotao.application.mock.a.bean.IdentityModel;
import com.taotao.application.mock.a.utils.ParamUtils;
import com.taotao.proto.grpc.demo.*;
...
public class ClientConsumer {
    ...
    @GrpcClient("mygrpc-server")
    private HelloAPIGrpc.HelloAPIBlockingStub stub2;
        ...
        if (null != list) {
            list.forEach((v) -> {
                personalInfo.Builder ryjblbBuilder = personalInfo.newBuilder()
                        .setIdentityNumber(ParamUtils.getInt(v.getIdentityNumber()))
                        .setName(ParamUtils.getString(v.getName()));
    ...
    public JSONObject sayHello() {
        ...
        HelloRequest request = HelloRequest.newBuilder()
                ...
                .setSex("1")
                .build();
        HelloResponse resp = stub2.sayHello(request);
        json.put("resp", resp.getMessage().toString()); json.put("req",request.toBuilder().toString());
        return json;
    }
}
